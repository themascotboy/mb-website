...
export const PortfolioManager = () => {
  ...
  const [formData, setFormData] = useState({ title: '', description: '', imageUrl: '', link: '', category: '' });
  ...
  const handleEdit = (item: any) => {
    ...
    setFormData({ title: item.title, description: item.description, imageUrl: item.imageUrl || '', link: item.link || '', category: item.category || '' });
    setIsOpen(true);
  };

  const handleNew = () => {
    setEditingId(null);
    setFormData({ title: '', description: '', imageUrl: '', link: '', category: '' });
    setIsOpen(true);
  };
